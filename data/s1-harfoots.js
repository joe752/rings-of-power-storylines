window.SEASONS.s1.storylines.harfoots = {
  title: "Harfoots & the Stranger", cast: ["nori", "poppy", "stranger", "sadoc", "largo"], location: "Rhovanion migration trail", art: "scene-harfoots", color: "oklch(72% 0.12 345)",
  episodes: [
    { summary: "Nori cannot stop looking beyond the familiar.", beats: [
      ...
      ], place: ["rhovanion"], people: ["nori", "sadoc", "stranger"], why: "The episode establishes the trait that drives Nori's choices: when caution tells her to turn away, curiosity and concern pull her closer. Finding the Stranger matters because Nori is the kind of person who chooses to look.", blurb: "Nori looks beyond the safe path" },
    { summary: "Nori turns curiosity into responsibility.", beats: [
      ...
      ], place: ["rhovanion"], people: ["nori", "poppy", "stranger"], why: "Nori's defining choice is not simply discovering the Stranger; it is deciding that finding someone helpless creates a responsibility to them. The episode also makes clear that kindness does not erase risk or uncertainty.", blurb: "A constellation appears" },
    { summary: "Nori's secret collides with the Harfoots' rules for survival.", beats: [
      ...
      ], place: ["rhovanion"], people: ["nori", "stranger", "largo", "sadoc"], why: "The episode refuses to make either Nori or the Harfoots simply wrong. Nori sees a person in need; the community sees a threat to everyone. Her compassion now carries consequences she has to live with rather than merely defend.", blurb: "He joins the migration" },
    null,
    { summary: "The Stranger protects the Harfoots, then frightens the person who trusted him first.", beats: [
