window.SEASONS.s1.storylines.southlands = {
  title: "The Southlands", cast: ["arondir", "bronwyn", "theo", "adar", "waldreg"], location: "Tirharad · Hordern · Ostirith", art: "scene-southlands", color: "oklch(72% 0.12 55)",
  episodes: [
...
window.SEASONS.s1.storylines["southlands-shadow"] = {
...
window.SEASONS.s1.storylines["arondir-below"] = {
...
window.SEASONS.s1.storylines["theo-and-return"] = {
...
window.SEASONS.s1.storylines["southlands-surrender"] = {
  ...
  episodes: [null, null, null, null,
    {
      ...
      why: "The Southlanders are divided by two competing responses to fear: resist an uncertain future, or submit to a power that promises survival. Theo's sword is clearly part of the threat, but the episode does not yet reveal what it is actually for.",
